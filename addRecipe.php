...
<body>
  ...
  <main>
    ...
    <form id="recipeForm">
      ...
      <input type="text" placeholder="Choclate cake" id="name" required>
      ...
      <textarea id="description"
        placeholder="This chocolate cake uses butter for flavor and a bit of oil for a never-fail moist crumb, ideal for celebrations. With more of a milk chocolate, rather than dark chocolate flavor, it's perfect for kids."
      ...
      <div id="ingredients">
        <div class="row">
          <input type="text" placeholder="Flour" required>
          <input type="text" placeholder="1 Cup" required>
      ...
      <div id="instructions">
        <div class="row">
          <input type="text"
            placeholder="Preheat the oven to 350°F. Lightly grease and flour your choice of pans: one 9 x 13 pan, two 9 round pans, or three 8 round pans. (To make a four-layer cake, use two 9round pans; the layers will each be split in half.)"
            required>
          <button type="button" onclick="removeRow(this)">✕</button>
        </div>
      </div>
