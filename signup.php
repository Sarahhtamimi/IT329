  ...
  <style>
    ...
    * {
    ...
    .file {
      ...
      flex-wrap: wrap;
      padding: 12px;
      border: 1px dashed rgba(114, 92, 58, .22);
      border-radius: var(--r-md);
...
<main class="container">
  <section class="card">
    <div class="card-pad">
      ...
      <p class="sub">
        All fields are required except the profile image.
      </p>
  ...
  <p class="error-msg">
    <?php
      ...
      elseif ($_GET['error'] == 'blocked') echo "This email is blocked from creating an account.";
      elseif ($_GET['error'] == 'weak_password') echo "Password must be at least 8 characters and include uppercase, lowercase, and a special character.";
      elseif ($_GET['error'] == 'insert_failed') echo "Something went wrong. Please try again.";
    ?>
  </p>
<?php } ?>
      <form id="signupForm" action="process_signup.php" method="POST" enctype="multipart/form-data">
        <div class="row">
          <div>
            ...
            <input class="field" id="firstName" name="firstName" type="text" placeholder="Noura" required>
          </div>
          <div>
            <label for="lastName">Last name *</label>
            <input class="field" id="lastName" name="lastName" type="text" placeholder="Abdulaziz" required>
          </div>
        </div>
        ...
        <div>
          ...
          <div class="file">
            ...
            <span class="hint">If you don’t upload a photo, a default avatar will be used.</span>
          </div>
        </div>
        ...
        <div>
          ...
          <?php if (isset($_GET['error']) && $_GET['error'] == 'weak_password') { ?>
            <p class="error-msg">Password does not meet the required conditions.</p>
          <?php } ?>
        </div>
        ...
        <div class="small-note" id="note" aria-live="polite"></div>
      </form>
    </div>
  </section>
</main>
